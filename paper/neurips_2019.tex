...
\begin{figure}[ht!]
	...
	\caption{Latent means of GPLVM for Anuran Call data set. Left panel refers to no regularization and the other three have regularization with different weights $\lambda = 10^3, 10^7$. Different colors denote different genus types and crosses denote inducing inputs.}
	\label{fig:ANURAN}
\end{figure}
