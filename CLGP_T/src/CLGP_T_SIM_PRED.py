...
if __name__ == "__main__":
    ...
    #     plt.scatter(ms_2[labels==i,sens_order[-1]], ms_2[labels==i,sens_order[-2]], color = c, label = "{},{}".format(int(i/3),i%3))
